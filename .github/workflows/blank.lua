...
local cloneref = (identifyexecutor() ~= "Synapse Z" and not identifyexecutor():find("Delta") and cloneref) or function(o) return o end -- infinite yield
...
local Window = library:AddWindow("EZ Cracked")
